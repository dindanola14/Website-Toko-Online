...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Input Data RFAS MERCH</title>
    ...
    <nav>
      ...
      <ul>
        ...
        <li>
          <a href="#">Pelanggan</a>
          <ul>
            <li><a href="index.php?page=tambah_pelanggan">Tambah Pelanggan</a></li>
            <li><a href="index.php?page=tampil_pelanggan">Tampil Pelanggan</a></li>
          </ul>
        </li>
      </ul>
    </nav>
